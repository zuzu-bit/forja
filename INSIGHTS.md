...
outputs; both object and string model responses are supported. The card explanation
is assembled from received evidence on the server, not generated by the model;
sources with fewer than three records always have low confidence. UI text
